...
function Spotlights() {
  const quotes = [
    ...
    {
      quote:
        "I have had the pleasure of working with Chloe across several projects. She quickly grasps direction and delivers thoughtful creative solutions. She brings adaptability and initiative to every brief often presenting multiple approaches that elevate the final outcome.",
      by: "Jamie Wallace, Founder of OR
